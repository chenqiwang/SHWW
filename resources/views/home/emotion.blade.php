                ...
                <ul class="am-list">
                    ...
                    <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-left" >
                        <div class="am-u-sm-5 am-list-thumb">
                            <a href="/ngavig/answer?pid={{ $p->id }}&lname={{ $p->name }}&bname=<?= $_GET['lname'] ?>&photo={{ $p->photo }}&nickname={{ $p->nickname }}">
                                <img src="{{ asset('image/'.$p->photo) }}" height="100" width="80" alt="<?= $_GET['lname'] ?>"/>
                            </a>
                        </div>

                        <div class=" am-u-sm-7 am-list-main">
                            <h3 class="am-list-item-hd"><a href="/ngavig/answer?pid={{ $p->id }}&lname={{ $p->name }}&bname=<?= $_GET['lname'] ?>&photo={{ $p->photo }}&nickname={{ $p->nickname }}">{{ $p->name }}</a></h3>

                            <div class="am-list-item-text">{{ date('Y-m-d',$p->time) }}</div>
